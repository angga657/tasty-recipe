...
export default {
    ...
    actions: {
        async getRegisterData ({ commit, dispatch }, payload) {
            const APIkey = "AIzaSyApKf6wnIH__CuExv1fFSHRHCqs1em9Dw8";
        ...
        async addNewUser({ commit, state }, payload) {
            try {
                ...
                (
                    `https://vue-js-project-c8990-default-rtdb.firebaseio.com/user.json?auth=${state.token}`, payload
                );
        ...
        async getUser({ commit }, payload) {
            try {
                ...
                (
                    `https://vue-js-project-c8990-default-rtdb.firebaseio.com/user.json`
                )
